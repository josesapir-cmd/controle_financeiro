...
const VIAGEM: Categoria = { id: "cat-viagem", name: "Viagem", kind: "despesa", position: 10 };
const FAMILIA: Categoria = { id: "cat-familia", name: "Familia", kind: "despesa", position: 20 };
...
describe("totalPorTipo", () => {
  it("soma so as categorias do tipo pedido", () => {
    const { categorias } = cruzarCentrosDeCusto(
      [VIAGEM, { id: "r", name: "Renda", kind: "receita", position: 1 }],
      [],
      [
